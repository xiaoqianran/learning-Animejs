...
/** Anime.js 课站独立 storage，避免与其他 learning-* 冲突 */
export const CTP_STORAGE_KEY = "animejs-learn-ctp-flavor";
export const CTP_ACCENT_KEY = "animejs-learn-ctp-accent";
export const DEFAULT_CTP_FLAVOR: CtpFlavor = "mocha";
/** 默认 Green，贴合 Anime.js 活力色 */
export const DEFAULT_CTP_ACCENT: CtpAccent = "pink";
