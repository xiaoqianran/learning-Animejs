...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        title: "Anime.js 实战学习 · 交互路径",
      },
      {
        name: "description",
        content:
          "Anime.js 中文交互教程：清晰学习路径、文档地图、讲解+源码+Demo、Catppuccin 主题与动效秀场。",
      },
    ],
    links: [
...
const CTP_BOOT =
  "(function(){try{var f=localStorage.getItem('animejs-learn-ctp-flavor');var a=localStorage.getItem('animejs-learn-ctp-accent');var okF=['mocha','macchiato','frappe','latte'];var okA=['pink','mauve','blue','lavender','sapphire','teal','peach','green'];if(okF.indexOf(f)<0)f='mocha';if(okA.indexOf(a)<0)a='pink';document.documentElement.setAttribute('data-ctp-flavor',f);document.documentElement.setAttribute('data-ctp-accent',a);}catch(e){document.documentElement.setAttribute('data-ctp-flavor','mocha');document.documentElement.setAttribute('data-ctp-accent','pink');}})();";

function RootDocument({ children }: { children: ReactNode }) {
  return (
    <html lang="zh-CN" data-ctp-flavor="mocha" data-ctp-accent="pink">
      <head>
