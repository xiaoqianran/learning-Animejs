    ...
    <div className="mx-auto max-w-3xl pb-16">
        ...
        <div className="relative">
          ...
          <div className="mt-5 flex flex-wrap items-center gap-3">
            ...
            <span className="font-mono text-xs tabular-nums text-muted">
              {doneCount}/{LESSONS.length} · 主修进度 {progress}%
            </span>
        ...
        {[
          ...
          return (
            <Link
              ...
              to={item.to}
              className="flex items-start gap-3 rounded-xl border border-border bg-surface p-3.5 no-underline transition-colors hover:border-border-strong hover:bg-surface-2"
            >
      ...
      <section className="mt-10">
        <div className="mb-3 flex flex-wrap items-end justify-between gap-2">
          <div>
            ...
            <p className="text-xs text-muted">按顺序学完主修即可结业</p>
          </div>
        </div>
      ...
      <section className="mt-10">
        <div className="mb-3 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="搜索课程…"
              className="h-9 w-full rounded-lg border border-border bg-surface pl-8 pr-3 text-xs text-fg placeholder:text-subtle sm:w-52"
            />
          </div>
        </div>
        ...
        <ul className="space-y-2">
            ...
            return (
              <li key={lesson.slug}>
                ...
                >
                  <span
                    className={cn(
                      "mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-full font-mono text-[11px] font-medium",
                  ...
                  <span className="min-w-0 flex-1">
                    ...
                    <span className="mt-1 inline-flex flex-wrap items-center gap-2 text-[11px] text-subtle">
                      ...
                      {score !== undefined ? (
                        <span className="font-mono">测验 {score}%</span>
                      ) : null}
                    </span>
                  </span>
          ...
          {filtered.length === 0 ? (
            <p className="py-8 text-center text-sm text-muted">无匹配课程</p>
          ) : null}
        </ul>
      </section>
    </div>
